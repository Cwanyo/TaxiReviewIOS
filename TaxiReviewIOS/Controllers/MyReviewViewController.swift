...
class MyReviewViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
            ...
            if (!myRecentViewData.exists()){
                ...
                for r in myRecentViewData.children {
                    ...
                    self.getTaxiImage(taxiPlateNumber: key, completionHandler: { (tImage) in
                        ...
                        let t = myreviewTaxi(plateNumber: key, Image: tImage)
                        self.taxis.append(t)
